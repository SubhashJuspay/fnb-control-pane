          ...
          memberships: [
            {
              ...
              tenant: {
                ...
                slug: 'acme',
                name: 'Acme',
                locations: [{ id: 'l1', slug: 'mission', name: 'Mission', currency: 'USD' }],
              },
              location: null,
            },
            {
              ...
              tenant: {
                ...
                name: 'Acme',
                locations: [
                  { id: 'l1', slug: 'mission', name: 'Mission', currency: 'USD' },
                  { id: 'l2', slug: 'soma', name: 'SoMa', currency: 'USD' },
                ],
              },
          ...
          memberships: [
            ...
            },
            {
              ...
              tenant: {
                ...
                slug: 'beta',
                name: 'Beta',
                locations: [{ id: 'l2', slug: 'hq', name: 'HQ', currency: 'EUR' }],
              },
