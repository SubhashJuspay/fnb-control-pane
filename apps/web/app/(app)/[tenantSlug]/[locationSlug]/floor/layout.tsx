...
/**
 * Location-scoped floor layout. Mirrors POS/KDS — any active staff
 * membership at the location can open the live floor view. The api also
 * enforces `staff: true` on `floorTables`/`floorUpdates`, so this is
 * defence in depth. Renders a flush full-bleed shell.
 */
