...
/**
 * Floor editor — manager scope. Defends in depth alongside the api's
 * `manager: true` authScope on every floor mutation.
 */
export default async function FloorEditLayout({
  children,
  params,
}: {
